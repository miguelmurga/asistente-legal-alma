...
const ContactSection: React.FC = () => {
    ...
    return (
        <section id="contacto" className="py-24 sm:py-32 bg-primary text-light-text" aria-labelledby="contact-heading">
            <div className="container mx-auto px-6 text-center">
                ...
                >
                    ...
                    <h2 id="contact-heading" className="text-4xl md:text-5xl font-serif font-bold text-white mb-6">
                        Inicie su Consulta
                    </h2>
                ...
                <div className="max-w-5xl mx-auto mt-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        >
                            <h3 className="font-serif text-2xl text-accent mb-6">Canales Directos</h3>
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    <Phone aria-hidden="true" className="w-6 h-6 text-accent flex-shrink-0 mt-1"/>
                                    <div>
                                ...
                                <div className="flex items-start gap-4">
                                    <MapPin aria-hidden="true" className="w-6 h-6 text-accent flex-shrink-0 mt-1"/>
                                    <div>
                                        <p className="font-semibold text-white text-lg">Despacho</p>
                                        <a href="https://maps.app.goo.gl/KAQQRcT8i2HFGXWb6" target="_blank" rel="noopener noreferrer" className="text-light-text/80 hover:text-white transition-colors">
                        ...
                        <motion.div 
                            ...
                            className="bg-white/10 backdrop-blur-md rounded-2xl p-8 sm:p-10 text-left border border-white/20"
                        >
                            <h3 className="font-serif text-2xl text-accent mb-6">Pago de Asesoría</h3>
                            <div className="space-y-4 text-light-text/80">
                                ...
                                <div className="pt-4">
                                    <p className="font-semibold text-white mb-2" id="account-label">Cuenta de Débito (BBVA)</p>
